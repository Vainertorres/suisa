...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('aseg', '0002_nivelsisben_alter_maestrosub_nivelsisben'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='nivelsisben',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='aseg.nivelsisben'),
        ),
        ...
        migrations.AlterField(
            model_name='maestrosub',
            name='condiciondiscapacidad',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='aseg.condiciondiscapacidad'),
        ),
    ]
