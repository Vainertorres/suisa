    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apellido2new', models.CharField(blank=True, max_length=60, null=True)),
                ('novlcregtipo1', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='aseg.novlcregtipo1')),
                ('tipodoc', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tdnovlc4', to='cnf.tipodoc')),
